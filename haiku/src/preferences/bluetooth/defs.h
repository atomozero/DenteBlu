...
static const uint32 kMsgItemSelected = 'iSel';
...
static const uint32 kMsgPbapBrowser = 'pbBr';
static const uint32 kMsgCallDevice = 'clDv';
static const uint32 kMsgA2dpPlayer = 'a2dp';
