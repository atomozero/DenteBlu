...
// IO Capability values for SSP
#define HCI_IO_DISPLAY_ONLY			0x00
#define HCI_IO_DISPLAY_YES_NO		0x01
#define HCI_IO_KEYBOARD_ONLY		0x02
#define HCI_IO_NO_INPUT_NO_OUTPUT	0x03
...
// User passkey notification (event 0x3B, defined below)
...
/* Synthetic event: SMP Numeric Comparison request from kernel SMP module */
#define HCI_EVENT_SMP_NC_REQUEST					0xFE
struct hci_ev_smp_nc_request {
	bdaddr_t	bdaddr;
	uint16		conn_handle;
	uint32		numeric_value;
} __attribute__ ((packed));
